...
contains(PEOPLE_NEED_QT_PLUGINS, 1) {
    DEFINES += PEOPLE_NEED_QT_PLUGINS
...
SOURCES += \
    ...
    src/qt/peoplegui.cpp \
    src/qt/people.cpp \
    src/qt/peoplebridge.cpp
...
macx:ICON = src/qt/res/icons/people.icns
macx:TARGET = "Hpeople"
