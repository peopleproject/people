...
std::string HelpMessage()
{
    ...
    strUsage += "  -conf=<file>           " + _("Specify configuration file (default: people.conf)") + "\n";
    strUsage += "  -pid=<file>            " + _("Specify pid file (default: peopled.pid)") + "\n";
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    // Make sure only a single People process is using the data directory.
