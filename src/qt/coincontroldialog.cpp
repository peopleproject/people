...
void CoinControlDialog::updateLabels(WalletModel *model, QDialog *dialog, PeopleBridge *bridge)
{
    if (!model) return;
    ...
    } else
    {
        ...
        int nDisplayUnit = BitcoinUnits::MEN;
        ...
        l8->setStyleSheet((nChange > 0 && nChange < CENT) ? "color:red;" : ""); // Change < 0.01MEN
