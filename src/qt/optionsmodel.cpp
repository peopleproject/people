...
void OptionsModel::Init()
{
    ...
    nDisplayUnit = settings.value("nDisplayUnit", BitcoinUnits::MEN).toInt();
    ...
    fAutoRedeemPeople = settings.value("fAutoRedeemPeople", false).toBool();
...
QVariant OptionsModel::data(const QModelIndex & index, int role) const
{
    if(role == Qt::EditRole)
    {
        ...
        case AutoRedeemPeople:
            return fAutoRedeemPeople;
        case MinRingSize:
            return nMinRingSize;
        case MaxRingSize:
            return nMaxRingSize;
...
QString OptionsModel::optionIDName(int row)
{
    ...
    case AutoRedeemPeople: return "AutoRedeemPeople";
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DisplayAddresses:
            ...
            emit displayUnitChanged(settings.value("nDisplayUnit", BitcoinUnits::MEN).toInt());
            break;
        case DetachDatabases: {
        ...
        case AutoRingSize: {
            ...
            break;
        case AutoRedeemPeople: {
            fAutoRedeemPeople = value.toBool();
            settings.setValue("fAutoRedeemPeople", fAutoRedeemPeople);
            }
            break;
        case MinRingSize: {
...
bool OptionsModel::getAutoRedeemPeople() { return fAutoRedeemPeople; }
