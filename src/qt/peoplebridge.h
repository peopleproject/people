#ifndef PEOPLEBRIDGE_H
#define PEOPLEBRIDGE_H
...
class PeopleBridge : public QObject
{
    Q_OBJECT
...
public:
    explicit PeopleBridge(PeopleGUI *window, QObject *parent = 0);
    ~PeopleBridge();
