...
/**
  People GUI main class. This class represents the main window of the People UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class PeopleGUI : public QMainWindow
{
    Q_OBJECT
public:
    explicit PeopleGUI(QWidget *parent = 0);
    ~PeopleGUI();
