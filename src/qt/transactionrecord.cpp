...
QString TransactionRecord::getTypeLabel(const int &type)
{
    ...
    case RecvWithAddress:
        return PeopleGUI::tr("Received with");
    case RecvFromOther:
        return PeopleGUI::tr("Received from");
    case SendToAddress:
    case SendToOther:
        return PeopleGUI::tr("Sent to");
    case SendToSelf:
        return PeopleGUI::tr("Payment to yourself");
    case Generated:
        return PeopleGUI::tr("Mined");
    case RecvPeople:
        return PeopleGUI::tr("Received people");
    case SendPeople:
        return PeopleGUI::tr("Sent people");
    case Other:
        return PeopleGUI::tr("Other");
    default:
        return "";
    }
}
...
QString TransactionRecord::getTypeShort(const int &type)
{
    ...
    case TransactionRecord::RecvPeople:
        return "input";
    case TransactionRecord::SendToAddress:
    case TransactionRecord::SendToOther:
    case TransactionRecord::SendPeople:
        return "output";
    default:
        return "inout";
    }
...
QList<TransactionRecord> TransactionRecord::decomposeTransaction(const CWallet *wallet, const CWalletTx &wtx)
{
    ...
    int64_t nCredMEN, nCredPeople;
    wtx.GetCredit(nCredMEN, nCredPeople, true);
    int64_t nCredit = nCredMEN + nCredPeople;
    ...
    {
        if (nNet > 0 && nCredPeople > 0)
        {
            // -- credit
            TransactionRecord sub(hash, nTime, TransactionRecord::RecvPeople, "", "", nNet, 0);
        ...
        {
            // -- debit
            TransactionRecord sub(hash, nTime, TransactionRecord::SendPeople, "", "", nNet, 0);
        ...
        for (unsigned int nOut = 0; nOut < wtx.vout.size(); nOut++)
        {
                ...
                && txout.IsAnonOutput())
            {
                ...
                if (wallet->HaveKey(ckidD))
                {
                    ...
                    sub.type = TransactionRecord::RecvPeople;
    ...
    } else
    {
        ...
        BOOST_FOREACH(const CTxIn& txin, wtx.vin)
        {
                ...
                && txin.IsAnonInput())
            {
                ...
                {
                    fAllFromMe = false;
                    break; // display as send/recv people
                };
                continue;
            };
        ...
        if (fAllFromMe)
        {
            ...
            for (unsigned int nOut = 0; nOut < wtx.vout.size(); nOut++)
            {
                    ...
                    && txout.IsAnonOutput())
                {
                    ...
                    sub.type = TransactionRecord::SendPeople;
                    sub.address = CBitcoinAddress(ckidD).ToString();
