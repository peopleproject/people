...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "people.conf"));
                    ...
                    map<string, vector<string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good())
        return; // No people.conf file is OK
    ...
    {
        // Don't overwrite existing settings so command line settings override people.conf
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "peopled.pid"));
